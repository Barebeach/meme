      ...
      <nav className="top-nav">
        <div className="nav-content">
          ...
          <div className="social-links">
            <a href="https://youtube.com/@memetalk" target="_blank" rel="noopener noreferrer" className="social-link" title="YouTube">
            ...
            <a href="https://t.me/memetalktv" target="_blank" rel="noopener noreferrer" className="social-link" title="Telegram">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
